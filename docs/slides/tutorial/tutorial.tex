...
\small This is the decision step in the ReAct loop: given the conversation and
latest observations, the model either requests an action (a tool call) or
returns its final answer. \texttt{tool\_choice="auto"} permits both outcomes;
